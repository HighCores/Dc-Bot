        ...
        switch (type) {
            case "discount" -> {
                ...
                event.replyModal(Modal.create("gw_modal_discount", "DISCOUNT SEQUENCE CONFIG")
                        .addComponents(Label.of("Discount Telemetry", details), Label.of("Target Node ID", channel), 
                                Label.of("Duration (Minutes)", duration), Label.of("Winner Quantity", winners)).build()).queue();
            }
            case "coupon" -> {
                TextInput details = TextInput.create("gw_details", TextInputStyle.PARAGRAPH)
                ...
                event.replyModal(Modal.create("gw_modal_coupon", "COUPON SEQUENCE CONFIG")
                        .addComponents(Label.of("Coupon Telemetry", details), Label.of("Target Node ID", channel), 
                                Label.of("Duration (Minutes)", duration), Label.of("Winner Quantity", winners)).build()).queue();
            }
            case "free_service" -> {
                TextInput details = TextInput.create("gw_details", TextInputStyle.PARAGRAPH)
                ...
                event.replyModal(Modal.create("gw_modal_free_service", "SERVICE SEQUENCE CONFIG")
                        .addComponents(Label.of("Service Telemetry", details), Label.of("Target Node ID", channel), 
                                Label.of("Duration (Minutes)", duration), Label.of("Winner Quantity", winners)).build()).queue();
            }
            case "custom" -> {
                TextInput details = TextInput.create("gw_details", TextInputStyle.PARAGRAPH)
                ...
                event.replyModal(Modal.create("gw_modal_custom", "CUSTOM SEQUENCE CONFIG")
                        .addComponents(Label.of("Prize Telemetry", details), Label.of("Target Node ID", channel), 
                                Label.of("Duration (Minutes)", duration), Label.of("Winner Quantity", winners)).build()).queue();
            }
        }
    }
