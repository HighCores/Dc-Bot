...
public class PanelService {
    ...
    public static void sendPingsPanel(Object target) {
        ...
        // UNIQUE BANNER: Notification Matrix
    ...
    public static void sendColorsPanel(Object target) {
        ...
        // UNIQUE BANNER: Identity Calibration
        replyEphemeral(target, EmbedUtil.containerBranded("IDENTITY", "Color Selection", "Define your presence within the grid.", EmbedUtil.BANNER_COLORS, null, r1, r2));
    }
