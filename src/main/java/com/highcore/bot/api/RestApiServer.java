...
public class RestApiServer {
    ...
    private static void sendEmbed(Context ctx) {
        ...
        channel.sendMessageComponents(com.highcore.bot.utils.EmbedUtil.containerBranded("API", title, desc, null)).useComponentsV2(true).queue();
