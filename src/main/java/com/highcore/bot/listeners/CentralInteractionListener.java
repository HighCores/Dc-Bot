...
public class CentralInteractionListener extends ListenerAdapter {
    ...
    public void onButtonInteraction(@NotNull ButtonInteractionEvent event) {
        ...
        if (id.equals("support_start")) {
            TextInput subject = TextInput.create("subject", TextInputStyle.SHORT).setLabel("Problem Brief").setPlaceholder("Describe the technical issue...").setRequired(true).build();
        ...
        if (id.equals("report_start")) {
            TextInput reason = TextInput.create("reason", TextInputStyle.PARAGRAPH).setLabel("Report Context").setPlaceholder("What are you reporting?").setRequired(true).build();
