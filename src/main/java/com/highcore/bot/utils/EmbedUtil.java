...
public class EmbedUtil {
    ...
    // ibb.co blocks Discord hotlinking — set to null to disable banner until re-hosted
    public static final String BANNER_MAIN     = null;
    public static final String BANNER_SUPPORT  = null;
    public static final String BANNER_GIVEAWAY = null;
    public static final String BANNER_INVOICE  = null;
    public static final String BANNER_TICKET_PANEL = null;
    public static final String BANNER_ORDER_TIK    = null;
    ...
    public static Container accessDenied()                             { return coloredContainer("Access Denied", "Unauthorized.", DANGER); }
